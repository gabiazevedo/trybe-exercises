...
db.movies.updateMany({ title: "Home Alone"}, { $push: { cast: { $each: [{
...
db.movies.updateMany({ title: "Batman"}, { $push: { cast: { $each: [{
  "character": "Batman"
},
{
  "character": "Alfred"
...
// Querie 1: Adicione o campo actor , que deve ser um array com o valor Christian Bale , ao array de cast em que o campo
// character seja igual a Batman;

db.movies.updateOne({ title: "Batman", "cast.character": "Batman" }, { $push: { "cast.$.actor":  "Christian Bale" }});

// Querie 2: Adicione o campo actor , que deve ser um array com o valor Michael Caine , ao array de cast em que o campo
// character seja igual a Alfred;

db.movies.updateOne({ title: "Batman", "cast.character": "Alfred" }, { $push: { "cast.$.actor":  "Michael Caine" }});

// Querie 3: Adicione o campo actor , que deve ser um array com o valor Heath Ledger , ao array de cast em que o campo
// character seja igual a Coringa.

db.movies.updateOne({ title: "Batman", "cast.character": "Coringa" }, { $push: { "cast.$.actor":  "Heath Ledger" }});


// Exercício 12: Adicione aos atores de cast do character Batman do filme Batman os valores "Michael Keaton" ,
