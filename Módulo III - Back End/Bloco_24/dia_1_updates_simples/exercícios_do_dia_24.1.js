...
db.movies.updateOne({ budget: 35 }, { $rename: { "budget": "estimatedBudget" } });
...
// Exercício 10 : Utilizando o operador $currentDate , crie um campo chamado lastUpdated com o tipo timestamp no
// filme Home Alone.

db.movies.updateOne({ title: "Home Alone" }, { $currentDate: { lastUpdated: { $type: "timestamp" }}});

// Exercício 11 : Utilizando uma única operação, crie um campo chamado sequels e atribua a ele o valor 0 em todos os
// documentos.
...
// Exercício 13 : Para os filmes Batman ou Home Alone , atribua a imdbRating o valor 17 , caso o valor de imdbRating seja
// menor que 17.
...
// Exercício 15 : Produza uma query que renomeie os campos de name para hero_name , e de true_name para full_name ;
...
// Exercício 16 : Produza uma query onde os mutantes class omega ou gama passam a ter seu poder de 500 somente se seu
// poder for menor que 500.

db.xmen.updateMany({ class: { $in: ["omega", "gama"]}}, { $max: { power: 500} });

// Exercício 17 : Produza uma query onde os mutantes class gama passam a ter seu poder de 300 somente se seu poder for
// maior que 300.
...
// Exercício 19 : Em apenas uma query adicione o campo areas com o seguinte array como valor: ["Students Room"] a todos os
// mutantes que são Senior Staff que tenham poder acima de 100 e para todos os Junior Staff com poder acima de 200.
