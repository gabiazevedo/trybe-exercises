...
function nameAndAge() {
    const newObj = books.map((nameOfAuthor) => { 
        return {
          age: nameOfAuthor.releaseYear - nameOfAuthor.author.birthYear,
          author: nameOfAuthor.author.name, 
        }
    });
    return newObj.sort((obj1, obj2) => obj1.age - obj2.age);
}
